...
# Eliminar el terminador de registro, remplaza // por nada
clean_data = clean_data.replace("//", "")

# Eliminar cualquier cosa que no sea letra, se cambia por nada
...
#Extraemos del caracter 24 al 54
