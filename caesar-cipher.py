...
# Llamamos a la función suma para obtener el resultado y la imprimimos
print(suma(a, b))
...
def decryptMessage(message, cipherKey, alphabet):
    decryptKey = -1 * int(cipherKey) # La funcion encriptar suma y la de desencriptar resta el -1
