#Archivo que en donde estan los datos (BD), codigo que hace la conexión y en otro documento trabajamos con la conexión
#En este caso trabajamos con insulin.json- data: busca moleculas e insulina, toma el valor y lo guarda, jsonFileHand y cal_weight: calcula el peso molecular
...
if data != "": # Se busca dentro de data, insulina y moleculas
